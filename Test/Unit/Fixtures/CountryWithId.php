...
/**
 * Test double for Magento\Directory\Model\Country that explicitly declares
 * getCountryId().
 *
 * Real Magento (and this module's hand-written Magento stub) only expose
 * getCountryId() dynamically via AbstractModel/DataObject's __call() magic
 ...
 */
class CountryWithId extends Country
{
    /** @return mixed */
